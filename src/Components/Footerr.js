...
import photo1 from '../assests/footer.png'
export default function Footerr() {
  return (
    <>
      <div className='footer'>
        <img src={photo1} alt="Main Image" className="footer" />
        <div className='features'>
            <h3>Quick Links</h3>
            <li><a href="#chapters">Chapters</a></li>
            <li><a href="#events">Upcoming events</a></li>
            <li><a href="#about">About GDSC</a></li>
            <li><a href="#leads">Lead Terms</a></li>
            <li><a href="#participation">Participation Terms</a></li>
